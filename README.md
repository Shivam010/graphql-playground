<p align="center"><img src="./public/image-black.jpeg" width="500"></p>
...
Excisting License of [Graphcool](https://github.com/graphcool) is present in [LICENSE.graphcool](./LICENSE.graphcool) and new License file can be found in [LICENSE](./LICENSE) file.

Both licenses are MIT Licenses.

[![](./public/example.jpeg)](https://gql.rathore.ml/)
