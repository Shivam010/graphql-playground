...
function useAnalytics() {
  window.goatcounter = {
    ...
    allow_local: true,
    allow_frame: true,
    endpoint: "https://gql.goatcounter.com/count",
  };
  goatCounterFunction();
  track();
}
...
// Also: it is slightly modified
function goatCounterFunction() {
  ...
  window.goatcounter.url = function(vars) {
    ...
    data.rnd = Math.random()
      .toString(36)
      .substr(2, 5); // Browsers don't always listen to Cache-Control.
